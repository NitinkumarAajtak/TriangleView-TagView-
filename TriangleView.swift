...
//  AajTakHD
//
//  Created by Nitin Kumar on 30/12/22.
//
...
open class TriangleView: UIView {
    ...
    @IBInspectable var cornerRadius: CGFloat = 4 { didSet { updatePath() } }
    
    /// The radius for the top right and bottom right curvature
    @IBInspectable var rightEdgeRadius: CGFloat = 2 { didSet { updatePath() } }
    
    /// The radius for the right tip
    @IBInspectable var rightCornerRadius: CGFloat = 1 { didSet { updatePath() } }
